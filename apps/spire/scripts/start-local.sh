...
if [[ ! -f "$ENV_FILE" ]]; then
    {
        ...
        write_env VEX_ENABLE_DEV_ENTITLEMENTS "${VEX_ENABLE_DEV_ENTITLEMENTS:-1}"
        write_env VEX_ENABLE_DEV_BILLING_GRANTS "${VEX_ENABLE_DEV_BILLING_GRANTS:-1}"
        write_env VEX_BILLING_ALLOW_LOCAL_STORE_PAYLOADS "${VEX_BILLING_ALLOW_LOCAL_STORE_PAYLOADS:-1}"
        write_env VEX_BILLING_ENVIRONMENT "${VEX_BILLING_ENVIRONMENT:-sandbox}"
...
export VEX_ENABLE_DEV_ENTITLEMENTS="${VEX_ENABLE_DEV_ENTITLEMENTS:-1}"
export VEX_ENABLE_DEV_BILLING_GRANTS="${VEX_ENABLE_DEV_BILLING_GRANTS:-1}"
export VEX_BILLING_ALLOW_LOCAL_STORE_PAYLOADS="${VEX_BILLING_ALLOW_LOCAL_STORE_PAYLOADS:-1}"
export VEX_BILLING_ENVIRONMENT="${VEX_BILLING_ENVIRONMENT:-sandbox}"
...
echo "Dev entitlement overrides: ${VEX_ENABLE_DEV_ENTITLEMENTS}"
echo "Dev billing grants: ${VEX_ENABLE_DEV_BILLING_GRANTS}"
